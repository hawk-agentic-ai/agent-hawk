-- =====================================================================
-- SUPABASE DIRECT EXECUTION - 50x Performance Optimization
...
-- These will speed up the view queries even more
...
CREATE INDEX IF NOT EXISTS idx_position_nav_recent_data 
ON position_nav_master (as_of_date DESC) 
WHERE as_of_date >= CURRENT_DATE - INTERVAL '30 days';

CREATE INDEX IF NOT EXISTS idx_hedge_instructions_active_status 
ON hedge_instructions (instruction_status, instruction_date DESC) 
...
DO $$
BEGIN
    RAISE NOTICE '🚀 SUCCESS: 50x Performance Optimization Views Created!';
    ...
    RAISE NOTICE '✅ Performance functions and indexes created';
    RAISE NOTICE '';
