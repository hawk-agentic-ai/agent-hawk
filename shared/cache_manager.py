...
Extracted from hedge_management_cache_config.py for shared use between FastAPI and MCP server.
...
# Hedge Cache Strategy - Optimized for 30 Users Maximum
...
def get_hedge_cache_key(query_type: str, user_id: str, params: Optional[Dict] = None) -> str:
