...
Analyzes user prompts to determine intent and required data tables
Supports ALL template categories and types
"""
...
class PromptIntelligenceEngine:
    ...
    def setup_table_mappings(self):
        ...
        self.table_mappings = {
            ...
            PromptIntent.HEDGE_INCEPTION: [
                ...
                "currency_configuration", "booking_model_config"
            ],
            PromptIntent.HEDGE_ROLLOVER: [
    ...
    def validate_and_fix_currency(self, extracted_currency: str, user_prompt: str, user_currency: Optional[str]) -> str:
        ...
        return extracted_currency if extracted_currency else "USD"
        ...
        for param, pattern in self.param_extractors.items():
            ...
            if match:
                if param == 'amount':
                    ...
                    all_codes = re.findall(r'[A-Z]{3}', user_prompt)
                    valid_currency = None
                    for code in all_codes:
                        if code in self.valid_currencies:
                            ...
                            break
                    if valid_currency:
                        extracted[param] = valid_currency
                elif param == 'amount':
